  ...
  return (
    <section className="bg-purple text-white">
      <div className="flex flex-col gap-8 md:p-8 p-4">
        ...
        <h2 className="font-bold text-5xl ">Fadaa El Madina In Numbers</h2>
        <p className=" w-4/5 text-[16px] leading-normal tracking-wide ">
        ...
        <div className="flex gap-4 w-4/5 items-baseline  md:items-center md:flex-row flex-col border-b p-6  justify-between">
          <p className="text-7xl font-bold">200+</p>
          <div className="flex gap-4 flex-col">
            <h3 className="text-3xl font-medium">
        ...
        <div className="flex gap-4 w-4/5 items-baseline  md:items-center md:flex-row flex-col border-b p-6  justify-between">
          ...
          <div className="flex gap-4 flex-col">
            <h3 className="text-3xl font-medium">8+ Years of Experience</h3>
            <p>
